...
extern void g3x_Arrow(GLfloat r, GLfloat h, G3Xcolor col)
{
  ...
  glPushMatrix();
    ...
    glMaterialfv(GL_FRONT_AND_BACK,GL_AMBIENT,(G3Xcolor){0.,0.,0.});
  ...
  glPushMatrix();
  	...
  	glPushMatrix();
	  	...
	  	glPushMatrix();
    		...
    		glPushMatrix();
					glMaterialfv(GL_FRONT_AND_BACK,GL_AMBIENT,(G3Xcolor){0.1,0.1,0.1,0.66});
    			glMaterialfv(GL_FRONT_AND_BACK,GL_DIFFUSE,col);
    			glMaterialf(GL_FRONT_AND_BACK,GL_SPECULAR,0.);
    			gluQuadricDrawStyle(qobj,GLU_FILL);
