...
extern int g3x_CreateScrollh_d(char *name, double* prm, double min, double max, double mapfactor, char *info)
{
...
extern int g3x_CreateScrollh_i(char *name, int* prm, int min, int max, double mapfactor, char *info)
{
	G3Xscroll *scroll=NULL,*s;
	if (scrollhnum>=BLOCSIZE)
	{ fprintf(stderr,"\e[36m<g3x_CreateScrollh> :\e[1;31mNOMBRE MAX (%d)ATTEINT retour -1\e[0;0m\n",scrollhnum); return -1;}
...
extern int g3x_CreateAnonymousScrollh(char *name, double init, char *info)
{
	G3Xscroll *scroll=NULL,*s;
	if (scrollhnum>=BLOCSIZE)
...
extern int g3x_CreateScrollv_d(char *name, double* prm, double min, double max, double mapfactor, char *info)
{
	G3Xscroll *scroll=NULL;
...
extern int g3x_CreateScrollv_i(char *name, int* prm, int min, int max, double mapfactor, char *info)
{
	G3Xscroll *scroll=NULL;
	if (scrollvnum>=BLOCSIZE)
	{ fprintf(stderr,"\e[36m<g3x_CreateScrollv> :\e[1;31mNOMBRE MAX (%d)ATTEINT retour -1\e[0;0m\n",scrollvnum); return -1;}
...
extern int g3x_CreateAnonymousScrollv(char *name, double init, char *info)
{
	G3Xscroll *scroll=NULL;
	if (scrollvnum>=BLOCSIZE)
	{ fprintf(stderr,"\e[36m<g3x_CreateScrollv> :\e[1;31mNOMBRE MAX (%d)ATTEINT retour -1\e[0;0m\n",scrollvnum); return -1;}
